...
input,inaa,output = read_from_file_SPLIT( "data/final_test_data.first_block.500000.csv" )
#model.evaluate( x=[input,inaa], y=output, batch_size=32 )

predictions = model.predict( x=[input,inaa] )
